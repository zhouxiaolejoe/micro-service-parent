...
@AllArgsConstructor
@NoArgsConstructor
public class PayVoucherBillPO implements Serializable {
    /**
     * 支付凭证主键
     */
     ...
     * 清算额度通知单号
     */
    private String LQD_QUOTA_NOTICE_NO;

    /**
     * 支付凭证汇总清单号
     */
    private String PAY_CERT_SUM_NO;

    /**
     * 划款凭证单号
     */
    private String LQD_CERT_NO;
